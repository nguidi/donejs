        ...
        /** @Prototype */
        {
                ...
                createTable: function(element, options) {
                    ...
                    options.model.findAll(
                        ...
                        function(data){
                            ...
                            can.trigger(self.element,'tableCreated',{
                                    result: 'success'
                            })
                        },
                        function(){
                ...
                updateFilter: function(path){
                    ...
                    $.each(path,function(i,elem){
                        ...
                        if (typeof elem.type === 'boolean')
                            filter.bool = elem.type
                        else
                ...
                addRows: function(data) {
                    ...
                    if (isUndefined(self.options.row)) {
                        $.each(data.items,function(index,rawData) {
                            ...
                            self.element.find('tbody').append('<tr index='+i+'></tr>').data(rawData)
                        ...
                        $.each(data.items,function(index,element){
                            ...
                            self.element.find('tbody tr:last')
                                                .data(element)
                                                .attr('index',i)
                        })
                },
